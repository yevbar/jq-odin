...
instruction_child_count :: proc(program: ^Program, instruction: Instruction) -> Count {
	...
	case .Static_Iterator_Update:
		return 1
	case .Static_Field_Add_Field, .Static_Field_Optional_Identity:
		return 0
	case .Path, .Getpath, .Delpaths:
		return 1
	case .Setpath:
