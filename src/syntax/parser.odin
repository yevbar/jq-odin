		...
		if !term_ready {
			...
			case .Identifier:
				...
				if (spelling == "join" || spelling == "contains" || spelling == "split" || spelling == "index" || spelling == "rindex" || spelling == "indices" || spelling == "startswith" || spelling == "endswith" || spelling == "has" || spelling == "bsearch" || spelling == "flatten" || spelling == "ltrimstr" || spelling == "rtrimstr" || spelling == "trimstr") && token_is(parser, .Open_Paren) {
					...
					argument_is_literal := argument_node.kind == .String || argument_node.kind == .Number || (index_family && array_literal) || (spelling == "has" && (argument_node.kind == .Nan || argument_node.kind == .Null)) || (spelling == "bsearch" && argument_node.kind == .Identity && argument_node.container_kind == .Object && argument_node.has_value)
					if !argument_is_literal || (spelling != "bsearch" && argument_node.has_child) || (spelling == "bsearch" && !(argument_node.kind == .Identity && argument_node.container_kind == .Object) && argument_node.has_child) || (spelling != "bsearch" && !index_family && argument_node.has_value) || (spelling == "bsearch" && !(argument_node.kind == .Identity && argument_node.container_kind == .Object) && argument_node.has_value) || (spelling == "flatten" && argument_node.kind != .Number) || ((spelling != "flatten" && spelling != "has" && spelling != "bsearch" && !index_family) && argument_node.kind != .String) || (index_family && argument_node.kind != .String && argument_node.kind != .Number && !array_literal) || (spelling == "has" && argument_node.kind != .String && argument_node.kind != .Number && argument_node.kind != .Nan && argument_node.kind != .Null) || (spelling == "bsearch" && argument_node.kind != .Number && !(argument_node.kind == .Identity && argument_node.container_kind == .Object)) {
