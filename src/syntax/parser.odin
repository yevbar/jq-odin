...
lookahead_starts_supported_term :: proc(parser: ^Parser) -> bool {
	...
	case .Dot, .Recurse, .Field, .Number, .String_Start, .Format, .Minus, .Open_Paren,
	     .Open_Bracket, .Open_Brace, .Binding, .Try:
		return true
	case .If:
		return true
	case .Identifier:
