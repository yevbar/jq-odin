		...
		if !term_ready {
			...
			case .Identifier:
				...
				if spelling == "error" && !token_is(parser, .Open_Paren) {
					...
					if !stream_selector && !isempty_array_literal && (!argument_is_literal && !flatten_negative_literal || (spelling == "error" && argument_node.kind != .String) || (spelling != "bsearch" && spelling != "join" && spelling != "flatten" && spelling != "error" && spelling != "isempty" && spelling != "strftime" && spelling != "any" && spelling != "all" && spelling != "in" && spelling != "inside" && (spelling != "ltrimstr" && spelling != "rtrimstr" && spelling != "trimstr") && argument_node.has_child) || (spelling == "bsearch" && !bsearch_comma && !(argument_node.kind == .Identity && argument_node.container_kind == .Object) && argument_node.has_child) || (spelling == "join" && !join_comma && argument_node.has_child) || (spelling != "bsearch" && spelling != "join" && spelling != "flatten" && spelling != "error" && spelling != "strftime" && !index_family && !contains_object_literal && !contains_array_literal && !contains_scalar_literal && !in_container_literal && !trimstr_literal && argument_node.has_value) || (spelling == "bsearch" && !bsearch_comma && !(argument_node.kind == .Identity && argument_node.container_kind == .Object) && argument_node.has_value) || (spelling == "join" && !join_comma && argument_node.has_value) || (spelling == "flatten" && !flatten_comma && argument_node.has_value) || (spelling == "flatten" && !flatten_comma && argument_node.kind != .Number && !flatten_negative_literal) || ((spelling != "flatten" && spelling != "bsearch" && spelling != "join" && spelling != "has" && spelling != "error" && spelling != "isempty" && spelling != "strftime" && spelling != "any" && spelling != "all" && !index_family && !contains_object_literal && !contains_array_literal && !contains_scalar_literal && !in_container_literal && !trimstr_literal) && argument_node.kind != .String) || (index_family && argument_node.kind != .String && argument_node.kind != .Number && !array_literal) || (contains_object_literal && argument_node.container_kind != .Object) || (contains_array_literal && argument_node.container_kind != .Array) || (contains_scalar_literal && argument_node.kind != .Null && argument_node.kind != .Boolean && argument_node.kind != .Number && argument_node.kind != .String && argument_node.kind != .Nan && argument_node.kind != .Infinite) || (spelling == "has" && argument_node.kind != .String && argument_node.kind != .Number && argument_node.kind != .Nan && argument_node.kind != .Null) || (spelling == "bsearch" && !bsearch_comma && argument_node.kind != .Number && !(argument_node.kind == .Identity && argument_node.container_kind == .Object)) || (spelling == "join" && !join_comma && argument_node.kind != .String) || (spelling == "flatten" && flatten_comma && argument_node.kind != .Comma) || ((spelling == "any" || spelling == "all") && !any_not_literal)) {
