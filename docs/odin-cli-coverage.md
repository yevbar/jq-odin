...
pinned catalog now reports **440 passed, 82 failed, 0 harness errors**. The
...
materialized accumulator/extraction path. The remaining failures are primarily richer destructuring/foreach, update-path assignment,
