...
At integration head `4fce18ff`, the authoritative selected catalog measurement
...
and 0389; these remain parser/evaluator continuation work rather than routed
fallbacks.
